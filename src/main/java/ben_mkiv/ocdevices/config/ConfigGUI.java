...
public class ConfigGUI implements IModGuiFactory {
    ...
    {
        return new OCDevicesConfigGUI(parentScreen);
    }
    ...
    public static class OCDevicesConfigGUI extends GuiConfig {

        public OCDevicesConfigGUI(GuiScreen parentScreen){
            //I18n function basically "translates" or localizes the given key using the appropriate .lang file
            super(parentScreen, getConfigElements(), OCDevices.MOD_ID,
